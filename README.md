...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-auth-oauthlib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-auth-oauthlib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-auth-oauthlib
# for installing globally
pixi global install google-auth-oauthlib
```
...
It is possible to list all of the versions of `google-auth-oauthlib` available on your platform:
...
```
pixi search google-auth-oauthlib --channel conda-forge
```
